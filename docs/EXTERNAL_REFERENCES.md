...
| [garrytan/gbrain](https://github.com/garrytan/gbrain) | Optional graph-backed memory provider | external provider, explicit opt-in | MIT | `MemoryProviders`, `SkillRepository`, README |
