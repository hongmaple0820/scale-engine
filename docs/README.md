...
| [AGENT_ECOSYSTEM.md](AGENT_ECOSYSTEM.md) | ACP-first agent collaboration planning and external agent role catalog adoption |
| [PRODUCT_MODULE_TEMPLATES.md](PRODUCT_MODULE_TEMPLATES.md) | Reusable product module templates for auth, license-card, user management, and custom scaffolds |
