...
export class SkillInstaller implements ISkillInstaller {
  ...
  private INSTALL_CONFIGS: Map<string, SkillInstallConfig> = new Map([
    ...
    ['cua', { skillId: 'cua', method: 'pip-install', sourceUrl: 'https://github.com/trycua/cua', command: 'scale setup --pack external-cli --apply --yes', verification: 'python -c "import cua"' }],
    ...
    ['impeccable', { skillId: 'impeccable', method: 'npm-install', sourceUrl: 'https://github.com/pbakaus/impeccable', command: 'npx -y impeccable skills install --yes', verification: 'npx -y impeccable skills check' }],
    ['taste-skill', { skillId: 'taste-skill', method: 'npm-install', sourceUrl: 'https://github.com/LeonxlnX/taste-skill', command: 'npx -y skills add LeonxlnX/taste-skill --yes', verification: 'npx -y skills list | grep taste-skill' }],
    ['liteparse', { skillId: 'liteparse', method: 'npm-install', sourceUrl: 'https://github.com/run-llama/llamaparse-agent-skills', command: 'npx -y skills add run-llama/llamaparse-agent-skills --skill liteparse --yes', verification: 'lit --version' }],
    ...
    ['opensquilla', { skillId: 'opensquilla', method: 'npm-install', sourceUrl: 'https://github.com/opensquilla/opensquilla', command: 'npx -y skills add opensquilla/opensquilla --yes', verification: 'npx -y skills list | grep opensquilla' }],
