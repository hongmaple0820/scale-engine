...
export const DEFAULT_SKILL_ROUTING_POLICY: ResolvedSkillRoutingPolicy = {
  ...
  domains: {
    ...
    storageAnalysis: {
      ...
      recommendedSkills: ['storage-analyzer'],
      requiredArtifacts: ['skill-plan.md', 'skill-evidence.md', 'storage-analysis.md', 'verification.md'],
      requiredVerification: ['read-only-scan', 'html-report', 'cleanup-confirmation-boundary'],
    },
    diagramming: {
      detect: {
